...
return array(
    'ComposerAutoloaderInit5870699333e892b609c9a06bec7d05ec' => $vendorDir . '/composer/autoload_real.php',
    'Composer\\Autoload\\ClassLoader' => $vendorDir . '/composer/ClassLoader.php',
    'Composer\\Autoload\\ComposerStaticInit5870699333e892b609c9a06bec7d05ec' => $vendorDir . '/composer/autoload_static.php',
    ...
    'DivisionTest' => $baseDir . '/tests/demo/DivisionTest.php',
    ...
    'FastpayTest' => $baseDir . '/tests/demo/FastpayTest.php',
    'MerchantTest' => $baseDir . '/tests/demo/MerchantTest.php',
    'NotifyTest' => $baseDir . '/tests/demo/NotifyTest.php',
    'OrderTest' => $baseDir . '/tests/demo/OrderTest.php',
    ...
    'PagePayTest' => $baseDir . '/tests/demo/PagePayTest.php',
    'PayTest' => $baseDir . '/tests/demo/PayTest.php',
    ...
    'ReplcepayTest' => $baseDir . '/tests/demo/ReplcepayTest.php',
    ...
    'Test' => $baseDir . '/tests/demo/Test.php',
    ...
    'WeChatAuthenticateTest' => $baseDir . '/tests/demo/WeChatAuthenticateTest.php',
    ...
    'Yspay\\Gathering\\SDK\\DivisionClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\Factory' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\MerchantClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\OrderRefundClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\PagePayClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\PayClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\ReplcePayClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\WeChatAuthenticateClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\Gathering\\SDK\\fastpayClient' => $baseDir . '/src/yspay/Factory.php',
    'Yspay\\SDK\\Division' => $baseDir . '/src/yspay/common/division/Division.php',
    'Yspay\\SDK\\Fastpay' => $baseDir . '/src/yspay/gather/fastpay/Fastpay.php',
    'Yspay\\SDK\\Gathering\\Base' => $baseDir . '/tests/demo/Base.php',
    'Yspay\\SDK\\Gathering\\Kernel\\Common' => $baseDir . '/src/yspay/Common.php',
    'Yspay\\SDK\\Gathering\\Kernel\\Config' => $baseDir . '/src/yspay/Config.php',
    'Yspay\\SDK\\Gathering\\Kernel\\Validator' => $baseDir . '/src/yspay/util/Validator.php',
    'Yspay\\SDK\\Gathering\\Payment\\Common\\Models\\Response' => $baseDir . '/src/yspay/Response.php',
    'Yspay\\SDK\\Kernel\\Gathering\\Util\\ResponseChecker' => $baseDir . '/src/yspay/util/ResponseChecker.php',
    'Yspay\\SDK\\Merchant' => $baseDir . '/src/yspay/common/merchant/Merchant.php',
    'Yspay\\SDK\\Model\\AlijsapiRequest' => $baseDir . '/src/yspay/gather/pay/models/AlijsapiRequest.php',
    'Yspay\\SDK\\Model\\AuthenticateApplyQueryRequest' => $baseDir . '/src/yspay/authenticate/wechat/models/AuthenticateApplyQueryRequest.php',
    'Yspay\\SDK\\Model\\BarcodepayRequest' => $baseDir . '/src/yspay/gather/pay/models/BarcodepayRequest.php',
    'Yspay\\SDK\\Model\\BillDownloadurlGetRequest' => $baseDir . '/src/yspay/common/order/models/BillDownloadurlGetRequest.php',
    'Yspay\\SDK\\Model\\CupgetmulappUseridRequest' => $baseDir . '/src/yspay/gather/pay/models/CupgetmulappUseridRequest.php',
    'Yspay\\SDK\\Model\\CupmulappQrcodepayRequest' => $baseDir . '/src/yspay/gather/pay/models/CupmulappQrcodepayRequest.php',
    'Yspay\\SDK\\Model\\DSingleQuickQueryRequest' => $baseDir . '/src/yspay/replace/replcepay/models/DSingleQuickQueryRequest.php',
    'Yspay\\SDK\\Model\\DfBillDownloadurlGetRequest' => $baseDir . '/src/yspay/replace/replcepay/models/DfBillDownloadurlGetRequest.php',
    'Yspay\\SDK\\Model\\DfSingleQuickAcceptRequest' => $baseDir . '/src/yspay/replace/replcepay/models/DfSingleQuickAcceptRequest.php',
    'Yspay\\SDK\\Model\\DfSingleQuickInnerAcceptReq' => $baseDir . '/src/yspay/replace/replcepay/models/DfSingleQuickInnerAcceptReq.php',
    'Yspay\\SDK\\Model\\DirectpayCreatebyuserRequest' => $baseDir . '/src/yspay/gather/pagepay/models/DirectpayCreatebyuserRequest.php',
    'Yspay\\SDK\\Model\\DivisionOnlineAcceptRequest' => $baseDir . '/src/yspay/common/division/models/DivisionOnlineAcceptRequest.php',
    'Yspay\\SDK\\Model\\DivisionOnlineQueryRequest' => $baseDir . '/src/yspay/common/division/models/DivisionOnlineQueryRequest.php',
    'Yspay\\SDK\\Model\\FastpayAuthorizeMsgReq' => $baseDir . '/src/yspay/gather/fastpay/models/FastpayAuthorizeMsgReq.php',
    'Yspay\\SDK\\Model\\FastpayAuthorizeRequest' => $baseDir . '/src/yspay/gather/fastpay/models/FastpayAuthorizeRequest.php',
    'Yspay\\SDK\\Model\\FastpayRequest' => $baseDir . '/src/yspay/gather/fastpay/models/FastpayRequest.php',
    'Yspay\\SDK\\Model\\MerchantBalanceQueryRequest' => $baseDir . '/src/yspay/common/merchant/models/MerchantBalanceQueryRequest.php',
    'Yspay\\SDK\\Model\\MerchantWithdrawQueryRequest' => $baseDir . '/src/yspay/common/merchant/models/MerchantWithdrawQueryRequest.php',
    'Yspay\\SDK\\Model\\MerchantWithdrawRequest' => $baseDir . '/src/yspay/common/merchant/models/MerchantWithdrawRequest.php',
    'Yspay\\SDK\\Model\\MobileControlsPayRequest' => $baseDir . '/src/yspay/gather/pay/models/MobileControlsPayRequest.php',
    'Yspay\\SDK\\Model\\QrcodepayRequest' => $baseDir . '/src/yspay/gather/pay/models/QrcodepayRequest.php',
    'Yspay\\SDK\\Model\\TradeDeliveredRequest' => $baseDir . '/src/yspay/gather/pay/models/TradeDeliveredRequest.php',
    'Yspay\\SDK\\Model\\TradeOrderQueryRequest' => $baseDir . '/src/yspay/common/order/models/TradeOrderQueryRequest.php',
    'Yspay\\SDK\\Model\\TradeRefundGeneralAccountReq' => $baseDir . '/src/yspay/common/order/models/TradeRefundGeneralAccountReq.php',
    'Yspay\\SDK\\Model\\TradeRefundQueryRequest' => $baseDir . '/src/yspay/common/order/models/TradeRefundQueryRequest.php',
    'Yspay\\SDK\\Model\\TradeRefundRequest' => $baseDir . '/src/yspay/common/order/models/TradeRefundRequest.php',
    'Yspay\\SDK\\Model\\TradeRefundSplitRequest' => $baseDir . '/src/yspay/common/order/models/TradeRefundSplitRequest.php',
    'Yspay\\SDK\\Model\\TrusteeshipSignConfirmRequest' => $baseDir . '/src/yspay/gather/fastpay/models/TrusteeshipSignConfirmRequest.php',
    'Yspay\\SDK\\Model\\TrusteeshipSignRequest' => $baseDir . '/src/yspay/gather/fastpay/models/TrusteeshipSignRequest.php',
    'Yspay\\SDK\\Model\\TrusteeshipfastPayConfirmRequest' => $baseDir . '/src/yspay/gather/fastpay/models/TrusteeshipfastPayConfirmRequest.php',
    'Yspay\\SDK\\Model\\TrusteeshipfastPayReachievemsgRequest' => $baseDir . '/src/yspay/gather/fastpay/models/TrusteeshipfastPayReachievemsgRequest.php',
    'Yspay\\SDK\\Model\\TrusteeshipfastPayRequest' => $baseDir . '/src/yspay/gather/fastpay/models/TrusteeshipfastPayRequest.php',
    'Yspay\\SDK\\Model\\WapDirectpayCreatebyuserReq' => $baseDir . '/src/yspay/gather/pagepay/models/WapDirectpayCreatebyuserReq.php',
    'Yspay\\SDK\\Model\\WeChatAuthenticateApplyRequest' => $baseDir . '/src/yspay/authenticate/wechat/models/WeChatAuthenticateApplyRequest.php',
    'Yspay\\SDK\\Model\\WeChatUploadPicRequest' => $baseDir . '/src/yspay/authenticate/wechat/models/WeChatUploadPicRequest.php',
    'Yspay\\SDK\\Model\\WechatAuthenticateRequest' => $baseDir . '/src/yspay/authenticate/wechat/models/WechatAuthenticateRequest.php',
    'Yspay\\SDK\\Model\\WeixinPayRequest' => $baseDir . '/src/yspay/gather/pay/models/WeixinPayRequest.php',
    'Yspay\\SDK\\OrderRefund' => $baseDir . '/src/yspay/common/order/OrderRefund.php',
    'Yspay\\SDK\\PagePay' => $baseDir . '/src/yspay/gather/pagepay/PagePay.php',
    'Yspay\\SDK\\Pay' => $baseDir . '/src/yspay/gather/pay/Pay.php',
    'Yspay\\SDK\\Replcepay' => $baseDir . '/src/yspay/replace/replcepay/Replcepay.php',
    'Yspay\\SDK\\WeChatAuthenticate' => $baseDir . '/src/yspay/authenticate/wechat/WeChatAuthenticate.php',
